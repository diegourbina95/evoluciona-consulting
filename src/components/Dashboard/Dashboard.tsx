...
function Dashboard() {
  interface activity {
   ...
   const activitys: activity[] = [
    { id: 1, color: 'primary', data: 'Task Finished', data1: '09 July 2021', text: 'Adam Berry finished task on', text1: 'Project Management' },
    { id: 2, color: 'secondary', data: 'New Comment', data1: '05 July 2021', text: 'Victoria commented on Project', text1: 'Angular JS Template' },
    { id: 3, color: 'success', data: 'New Comment', data1: '25 June 2021', text: 'Victoria commented on Project ', text1: 'Angular JS Template' },
    { id: 4, color: 'warning', data: 'Task Overdue', data1: '14 June 2021', text: 'Petey Cruiser finished task', text1: 'Integrated Management' },
    { id: 5, color: 'danger', data: 'Task Overdue', data1: '29 June 2021', text: 'Petey Cruiser finished task ', text1: 'Integrated Management' },
  ]
  return (
    <Fragment>
        ...
        <Col xl={6} md={12}>
          <Card>
            ...
            <Card.Body className="pb-0">
              ...
              <ul className="task-list" key={Math.random()}>
                <li className="d-sm-flex">
                  <div>
                    <i className={`task-icon bg-${activity.color}`}></i>
                    <h6 className="fw-semibold">{activity.data}<span
                      className="text-muted fs-11 ms-2 fw-normal">{activity.data1}</span>
                    </h6>
                    <p className="text-muted fs-12">{activity.text}<Link to="#"
                      className="fw-semibold"> {activity.text1}</Link></p>
                  </div>
              ...
              <div className="browser-stats">
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("chrome")} className="img-fluid" alt="img"
                    />
                  </Col>
                ...
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("opera")} className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
                ...
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("ie")} className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
                ...
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("firefox")} className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
                ...
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("edge")} className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
                ...
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("safari")} className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
                ...
                <Row>
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src={Imagesdata("netscape")} className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
