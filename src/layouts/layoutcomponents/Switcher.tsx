...
//Buy Now 
  ...
  let viewDemoClose = (modal: string) => {
    switch (modal) {
      case "Basic":
        setShow1(false)
        break;
                ...
                <div className="predefined_styles">
                  <div className="swichermainleft text-center">
                    <div className="p-3 d-grid gap-2">
                      ...
                      <Link to='https://themeforest.net/item/sash-react-admin-dashboard-template/39157113' onClick={() => viewDemoShow("Basic")} className="btn ripple btn-secondary" target="_blank">Buy Now</Link>
