...
const t = (
  <span
    className={`text-center align-middle badge bg-danger-transparent rounded-pill text-danger p-2 px-3`}
  >
    Cancelled
  </span>
);
...
const d = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order10")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Headsets</h6>
    </div>
  </div>
);
const e = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order12")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Flower Pot</h6>
    </div>
  </div>
);
const f = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order4")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Pen Drive</h6>
    </div>
  </div>
);
const g = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order8")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">New Bowl</h6>
    </div>
  </div>
);
const h = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order6")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Leather Watch</h6>
    </div>
  </div>
);
const j = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("product6")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Digital Camera</h6>
    </div>
  </div>
);
const l = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order11")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Earphones</h6>
    </div>
  </div>
);
const m = (
  <div className="d-flex align-items-center">
    <img className="w-5 h-5 br-5 me-2" src={Imagesdata("order2")} />
    <div className="ms-1 d-block">
      <h6 className="mb-0 fs-14">Shoes</h6>
    </div>
  </div>
);
...
export const DATATABLE1 = [
  {
    PurchaseDate: "#98765490",
    ClientName: "Cherry Blossom",
    ProductID: "30 Aug 2021",
    Product: d,
  ...
  },
  {
    ...
    ProductID: "27 Jan 2021",
    Product: f,
    PaymentMode: "Cash on Delivery",
    Status: s,
    ProductCost: "$5,89,6437",
    Action: data1,
  },
  {
    PurchaseDate: "#98765490",
  ...
  },
  {
    ...
    ProductID: "25 Jun 2021",
    Product: l,
    PaymentMode: "Online Payment",
    Status: i,
    ProductCost: "$7,34,9768",
    Action: data1,
  },
  {
    PurchaseDate: "#98765490",
    ClientName: "Laura Biding",
    ProductID: "22 Feb 2021",
    Product: m,
    PaymentMode: "Cash on delivered",
    Status: t,
    ProductCost: "$7.76.654",
    Action: data1,
  },
];
...
const img = (
  <div className="d-flex align-items-center">
    <img
      className="w-5 h-5 br-5 me-2 align-middle"
      src={Imagesdata("order10")}
    />
    <span>Headsets</span>
  </div>
);
...
const data2 = (
  <div className="d-flex align-items-center">
    ...
    <OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
      <i className="fe fe-trash-2 text-danger fs-18 me-4"></i>
    </OverlayTrigger>
  </div>
);
