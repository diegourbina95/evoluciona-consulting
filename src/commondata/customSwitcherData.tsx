...
export const LightTheme = () => {
  let lightHeader1 = document.querySelector(
    "#myonoffswitch1"
  ) as HTMLInputElement;
...
export const Transparent = () => {
  ...
  let myonoffswitchTransparent = document.querySelector(
...
export function dynamicBgImgTransparentPrimaryColor(
  primaryColor: any,
  color: any
) {
  primaryColor.forEach((item: any) => {
...
export function bgimage1() {
  ...
  let TransparentTheme = document.getElementById(
    "myonoffswitchTransparent"
  ) as HTMLInputElement;
  ...
  let GradientHeader = document.querySelector(
    "#myonoffswitch2"
  ) as HTMLInputElement;
  GradientHeader.checked = false;
  let LightTheme = document.querySelector(
    "#myonoffswitch1"
  ) as HTMLInputElement;
  LightTheme.checked = false;
  let switchTransparent = document.querySelector(
    "#myonoffswitchTransparent"
  ) as HTMLInputElement;
...
export function bgimage2() {
  ...
  LightTheme.checked = false;
  let TransparentTheme = document.querySelector(
    "#myonoffswitchTransparent"
  ) as HTMLInputElement;
  TransparentTheme.checked = true;
}
...
export function bgimage3() {
  ...
  document.querySelector("body")?.classList.remove("bg-img2");
  document.querySelector("body")?.classList.remove("bg-img4");
  let switchTransparent = document.getElementById(
    "myonoffswitchTransparent"
  ) as HTMLInputElement;
  switchTransparent.checked = true;
  ...
  let offswitchTransparent = document.querySelector(
    "#myonoffswitchTransparent"
  ) as HTMLInputElement;
...
export function bgimage4() {
  ...
  document.querySelector("body")?.classList.remove("bg-img2");
  document.querySelector("body")?.classList.remove("bg-img3");
  let bgimage4s = document.getElementById(
    "myonoffswitchTransparent"
  ) as HTMLInputElement;
